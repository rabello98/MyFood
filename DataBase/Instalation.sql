...
CREATE TABLE DBO.OPR_PEDIDO_PRODUTO(
	ID BIGINT PRIMARY KEY IDENTITY,
	PEDIDO_ID FOREIGN KEY REFERENCES DBO.OPR_PEDIDO(ID) NOT NULL,
	PRODUTO_ID FOREIGN KEY REFERENCES DBO.CAD_PRODUTO(ID) NOT NULL,
	QUANTIDADE BIGINT NOT NULL
)
GO
ALTER TABLE DBO.OPR_PEDIDO_PRODUTO
ADD CONSTRAINT DBO.OPR_PEDIDO_PRODUTO_UK UNIQUE (PEDIDO_ID, PRODUTO_ID);